...
from .views import CartRemoveAllView, CartView, ImageViewFactory, ImageViewNoDI, ProductIndexView, ProductShowView, homePageView, AboutPageView, ContactPageView, ProductCreateView, product_created
